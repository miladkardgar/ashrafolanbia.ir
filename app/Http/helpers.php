...
function getEvents($shD,$shM,$icD=null,$icM=1,$wcD=null,$wcM=1){
    $curl = curl_init();

    curl_setopt_array($curl, array(
        CURLOPT_URL => "https://farsicalendar.com/api/sh".($icD?",ic":"").($wcD?",wc":"")."/".$shD.($icD?",".$icD:"").($wcD?",".$wcD:"")."/".$shM.($icD?",".$icM:"").($wcD?",".$wcM:"")."?category=iran,ShiaDays",
        ...
        CURLOPT_HTTPHEADER => array(
            ...
            "postman-token: 6d02efdd-3a78-a145-74a6-a57d9aca5020"
        ),
    ));
