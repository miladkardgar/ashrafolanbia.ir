                    ...
                    <div class="card-body table-responsive">
                        ...
                        <table class=" fullwidth table   table-lg">
                            ...
                            @foreach($caravan['persons'] as $person_caravan)
                                @php
                                    $supervisor = \App\person_caravan::with('person')->find($person_caravan['parent_id'])
                                @endphp
                                <tr  class="{{!$supervisor ? "bg-teal-300":""}}">
                                    <td class="p-2"></td>
                                    <td class="p-2">{{$supervisor ? $supervisor['person']['name']." - ".$supervisor['person']['family']:" - "}}</td>
