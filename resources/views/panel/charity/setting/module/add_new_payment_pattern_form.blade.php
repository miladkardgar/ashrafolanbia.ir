                ...
                <table class="table table-bordered table-striped">
                    ...
                    @foreach($payment_pattern['titles'] as $title)
                        <tr>
                            ...
                            <td>
                                <form method="POST"
                                      action="{{route('charity_payment_title_delete',['payment_pattern_id'=>$payment_pattern['id'],'payment_title_id'=>$title['id']])}}">
                                    {{csrf_field()}}
                                    <button type="submit"
                ...
                <table class="table border-danger table-bordered table-striped">
                    ...
                    @foreach($payment_pattern->titles()->onlyTrashed()->get() as $deleted_title)
                        <tr>
                            ...
                            <td>
                                <form method="POST"
                                      action="{{route('charity_payment_title_recover',['payment_pattern_id'=>$payment_pattern['id'],'payment_title_id'=>$deleted_title['id']])}}">
                                    @csrf
                                    <input type="hidden" name="payment_pattern_id" value="{{$payment_pattern['id']}}">
