    ...
    <div class="content">
        ...
        <div class="row card ">
            ...
            <div class="form-group col-md-6">
                <label for="Phones">شماره هایی که پس از خرید به آنها اطلاع داده میشود <span class="text-danger">*</span></label>
                <input type="text"
        ...
        <div class="row card">
            ...
            <div class="form-group col-md-4">
                <label for="Time">ساعت پایان روز کاری (سفارش ها بعد از این ساعت مثل سفارش های روز بعد است) <span class="text-danger">*</span></label>
        ...
        <div class="row card ">
            ...
            <div class="form-group col-md-6">
                ...
                <select id="Free_provinces" name="free_provinces[]"  multiple="multiple" class="form-control select" data-fouc>
            ...
            <div class="form-group col-md-6">
                ...
                <select id="Free_cities" name="free_cities[]" multiple="multiple" class="form-control select" data-fouc>
