                                ...
                                <div class="col-md-12 mb-sm-40">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 border-1px p-20">
                                            <div class="row">
                                                <div class="col-md-3 col-xs-6 pt-xs-10 pt-5">
                                                ...
                                                <div class="col-md-3 col-xs-6 pt-xs-10 pt-5">
                                                    <a href="{{route('vow_periodic')}}" class="btn btn-danger btn-block">{{__('messages.new_charity_period')}}</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped text-center table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">{{__('messages.description')}}</th>
                                                <th class="text-center">{{__('messages.status')}}</th>
                                                <th class="text-center">{{__('messages.pay_date')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody class="text-center">
                                            @foreach($paidPeriod as $paid)
                                                <?php $color = "label-warning" ?>
                                                <?php $text = "unpaid" ?>
                                                <?php $btn_color = "success" ?>
                                                @if($paid['status']=='paid')
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{miladi_to_shamsi_date($paid['payment_date'])}}</td>
                                                    <td class="text-center">{{$paid['description']}}</td>
                                                    <td class="text-center">
                                                        <span class="label {{$color}}">{{__("messages.".$paid['status'])}}</span>
                                                    </td>
                                                    <td class="text-center">
                                                        {{miladi_to_shamsi_date($paid['pay_date'])}}
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
