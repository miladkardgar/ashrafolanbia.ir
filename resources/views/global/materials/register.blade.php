<section class="">
    <div class="container" style="max-width: 700px">
        ...
        <div class="section-content bg-white p-30">
            <div class="row">
                <div class="col-md-12">
                    <form id="register_form" name="register_form" action="{{route('global_register_form_store')}}"
                          method="post">
                        {{@csrf_field()}}
                            ...
                            <div class="col-sm-12">
                                <div class="form-group ">
                                    <label for="phone_email" class="pull-right">{{trans('messages.email_or_mobile')}}
                                        <small>*</small></label>
                                    <input id="phone_email" dir="ltr" name="phone_email" type="text"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="password" dir="ltr" name="password"
                                           class="form-control required text-left" type="password"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="password_confirmation"
                                           class="pull-right">{{__('messages.repeat_password')}}
                                        <small>*</small></label>
                                    <input id="password_confirmation" dir="ltr" name="password_confirmation"
                                           class="form-control required text-left" type="password"
                                           placeholder="{{__('messages.repeat_repeat_password')}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit"
                                    ...
                                    data-loading-text="{{__("messages.please_waite")}}">{{__('messages.register_btn')}}</button>
                        </div>
                    </form>
                    <!-- Job Form Validation-->
