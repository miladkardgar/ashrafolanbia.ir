...
@section('css')
    <style>
        ...
        /* Style the back side */
        .flip-box-back {
            background: -webkit-linear-gradient(left, rgba(147,206,222,1) 0%, rgba(117,189,209,1) 41%, rgba(50,138,162,1) 95%, rgba(44,133,158,1) 100%);
            color: white;
            transform: rotateY(180deg);
        }
        .thumbnail {
                                                        ...
                                                        <div class="flip-box-front">
                                                            @if($media['media_two']['path'])
                                                                <img src="{{url($media['media_one']['path']."/300/".$media['media_one']['name'])}}"
                                                                     alt="{{$media['media_one']['title']}} - {{__('messages.ashraf')}}"
